...
module.exports = {
  ...
  loading: function() {
    return $("#nome").hasClass("ui-autocomplete-loading");
  },
...
casper.getCodRegistro = function(element) {
  return this.fetchText(element.selector).replace(/\./gi, '').replace(/\-/gi, '').replace(/\//gi, '');
};
